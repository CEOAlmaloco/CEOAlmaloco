#!/usr/bin/env python3
"""Generate an animated GitHub-streak SVG for CEOAlmaloco.
Adapted from AVIVASHISHTA29/scripts/generate_streak_svg.py
...
USER = sys.argv[1] if len(sys.argv) > 1 else "CEOAlmaloco"
...
def get_data(user):
    ...
    try:
        ...
        if os.path.exists(here):
            ...
            return json.load(open(here, encoding="utf-8"))
        raise
